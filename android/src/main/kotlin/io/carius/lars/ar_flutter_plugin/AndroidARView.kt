                ...
                when (call.method) {
                    ...
                    "placeGeospatial" -> {
                        ...
                        if (latitude == null || longitude == null || altitudeAboveTerrain == null || name == null || qx == null || qy == null || qz == null || qw == null) {
                            Log.w(
                                "GeoAnchor",
                                "Missing lat, long, alt, name or quaternion arguments."
                            )
                        ...
                        Log.d(
                            "GeoAnchor",
                            "Received arguments: lat=$latitude, lon=$longitude, alt=$altitudeAboveTerrain, name=$name, qx=$qx, qy=$qy, qz=$qz, qw=$qw"
                        )

                        val anchor = addGeospatialAnchor(
                            latitude,
                            longitude,
                    ...
                    "checkEarthTracking" -> {
                        ...
                        if (earth == null) {
                            result.error(
                                "EARTH_NOT_INITIALIZED",
                                "Earth object is not initialized.",
                                null
                            )
                            return
                        }
                        ...
                        resultMap["trackingState"] =
                            earth.trackingState.name // Convert enum to string
                            ...
                            when (anchorType) {
                                ...
                                1 -> { // Geospatial Anchor
                                    ...
                                    val altitudeAboveTerrain: Double? =
                                        call.argument<Double>("altitude")
                                    val name: String? = call.argument<String>("name")
                                    val cloudanchorid: String? =
                                        call.argument<String>("cloudanchorid")
                                    val qx = call.argument<Double>("qx")
                                    val qy = call.argument<Double>("qy")
                                    val qz = call.argument<Double>("qz")
                                    val qw = call.argument<Double>("qw")
                                    ...
                                    if (latitude == null || longitude == null || altitudeAboveTerrain == null || name == null || qx == null || qy == null || qz == null || qw == null) {
                                        ...
                                        result.error(
                                            "Error",
                                            "Missing arguments for geospatial anchor.",
                                            null
                                        )
                                        return
                                    }
...
//            cloudAnchorHandler.dispose();
    ...
    private fun addGeospatialAnchor(
        ...
        Log.d(
            "GeoAnchor",
            "addGeospatialAnchor called with lat: $latitude, lon: $longitude, alt: $altitude, qx: $qx, qy: $qy, qz: $qz, qw: $qw"
        )
        return try {
    ...
    private inner class cloudAnchorUploadedListener : CloudAnchorHandler.CloudAnchorListener {
        override fun onCloudTaskComplete(
            anchorName: String?,
            anchor: Anchor?,
            state: Anchor.CloudAnchorState,
            cloudAnchorId: String
        ) {
            val cloudState = state
            ...
            args["cloudanchorid"] = cloudAnchorId
